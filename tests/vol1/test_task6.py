...
class Test:
    def test_1(self):
        ...
        expected = "40 37 35 33 30 20 50 100 120 "
    ...
    def test_2(self):
        ...
        result = task.first_part_of_solution(tree)
        expected = "7 8 9 10 20 50 100 120 130 140 "
        assert result == expected
    ...
    def test_5(self):
        ...
        result = task.first_part_of_solution(tree)
        expected = "22 25 30 20 50 100 120 130 "
        assert result == expected
    ...
    def test_6(self):
        ...
        result = task.first_part_of_solution(tree)
        expected = "7 8 9 10 20 30 33 35 40 "
        assert result == expected
    ...
    def test_7(self):
        ...
        result = task.first_part_of_solution(tree)
        expected = "92 91 90 80 100 110 120 130 "
        assert result == expected
    ...
    def test_8(self):
        ...
        result = task.first_part_of_solution(tree)
        expected = "61 62 63 64 65 70 80 90 100 95 97 "
        assert result == expected
    ...
    def test_10(self):
        ...
        result = task.first_part_of_solution(tree)
        expected = "25 27 28 29 30 33 35 37 40 "
        assert result == expected
    ...
    def test_19(self):
        ...
        result = task.first_part_of_solution(tree)
        expected = "90 75 50 100 150 175 200 "
        assert result == expected
